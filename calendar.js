...
function selectDayView(el, targetEl, year, month, cYear, cMonth, cDay) {
    ...
    // 头部分
    var template =
        "<button name='clickin' id='clickin'>"+"确认"+"</button>"+
        "<div class='header'>" +
        "<div class='left' name ='pre'><img src='./toleft.png'></div>" +
        "<div class='middle' name='middle'>" + year + "年" + month + "月</div>" +
        "<div class='right' name ='next'><img src='./toright.png'></div>" +
        "</div>";

    template += "<div class='containter day-view'><ul>";
    ...
    var middleEl = document.getElementsByName('middle')[0];
    ...
    document.getElementsByName('clickin').forEach(function (itemNode) {
        itemNode.addEventListener('clickin', function () {
            targetEl.innerHTML = '';
        }, false);
    });
...
function selectMonthView(el, targetEl, year, cYear, cMonth, cDay) {
    ...
    var template =
        "<div class='header'>" +
        "<div class='left' name ='pre'><img src='./toleft.png'></div>" +
        "<div class='middle' name='middle'>" + year + "年</div>" +
        "<div class='right' name ='next'><img src='./toright.png'></div>" +
        "</div>";

    template += "<div class='containter month-view'><ul>";
...
function selectYearView(el, targetEl, year, cYear, cMonth, cDay) {
    ...
    // 内容部分
    template += "<div class='containter year-view'><ul>";
